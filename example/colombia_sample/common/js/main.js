...
requirejs.config({
	...
	paths:{
		...
		'sg-attr-draggable': 'lib/sg/sg.attr.draggable-1.0',
		'sg-tag-defaultPack': 'lib/sg/sg.tag.defaultPack-1.0'
	},
...
require(
	...
	[ 'jquery', 'jquery-ui', 'jquery-hittest', 'sg', 'sg-attr-defaultPack', 'sg-attr-draggable', 'sg-tag-defaultPack', 'jquery-easytabs', 'jquery-fancybox' ],
